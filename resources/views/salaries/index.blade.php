                        ...
                        <table cellpadding="5">
                            <thead>
                                <tr>
                                    ...
                                    <th><h6><strong>Bulan</strong></h6></th>
                                    <th><h6><strong>Gaji Pokok</strong></h6></th>
                                    <th><h6><strong>Tunjangan</strong></h6></th>
                                    <th><h6><strong>Potongan</strong></h6></th>
                                    <th><h6><strong>Total Gaji</strong></h6></th>
                            ...
                            <tbody>
                                @foreach ($salaries as $salary)
                                    <tr>
                                        <td><h6>{{ $salary->id }}</h6></td>
                                        <td><h6>{{ $salary->karyawan_id }}</h6></td>
                                        <td><h6>{{ $salary->bulan }}</h6></td>
                                        <td><h6>Rp {{ number_format($salary->gaji_pokok, 0, ',', '.') }}</h6></td>
                                        <td><h6>Rp {{ number_format($salary->tunjangan, 0, ',', '.') }}</h6></td>
                                        <td><h6>Rp {{ number_format($salary->potongan, 0, ',', '.') }}</h6></td>
                                        <td><h6>Rp {{ number_format($salary->gaji_pokok + $salary->tunjangan - $salary->potongan, 0, ',', '.') }}</h6></td>
                                        <td>
                                            <div class="dropdown">
